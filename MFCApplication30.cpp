...
// MFCApplication30.cpp : Определяет поведение классов для приложения.
//
...
CMFCApplication30App::CMFCApplication30App()
{
	...
	SetAppID(_T("MFCApplication30.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMFCApplication30App

CMFCApplication30App theApp;


// инициализация CMFCApplication30App
...
BOOL CMFCApplication30App::InitInstance()
{
	...
	m_pMainWnd->SetWindowTextW(L"Энергосбережение");
...
// обработчики сообщений CMFCApplication30App
...
void CMFCApplication30App::Mes(void)
{
	//AfxMessageBox(L"Mes");
	CMFCApplication30View* pList=(CMFCApplication30View*) theApp.GetRuntimeClass();
	pList->UpdView();
	pList=NULL; delete pList;
}


bool CMFCApplication30App::UpdateTree(void)
{
	CMainFrame* pfrm=(CMainFrame*) theApp.m_pMainWnd;

	CGenTree* ptree = (CGenTree*) pfrm->m_wndSplitter.GetPane(0,0);

	ptree->UpdateTree();

	//AfxMessageBox(L"bool CMFCApplication30App::UpdateTree(void)");

	ptree=NULL; delete ptree;
	pfrm=NULL; delete pfrm;
